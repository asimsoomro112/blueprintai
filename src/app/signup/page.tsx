...
export default function SignupPage() {
  ...
  return (
    <div className="premium-shell min-h-[calc(100vh-76px)] overflow-hidden px-4 py-10 sm:px-6">
      ...
      <div className="relative z-10 mx-auto grid min-h-[calc(100vh-140px)] max-w-6xl items-center gap-8 lg:grid-cols-[0.86fr_1fr]">
        <motion.section
        ...
        >
          ...
          <div className="relative">
            <div className="mb-8 text-center">
              ...
              <p className="mt-1 text-sm text-slate-500">Start converting sketches to polished code</p>
            </div>
            ...
            <p className="mt-6 text-center text-sm text-slate-500">
              ...
              <Link href="/login" className="font-black text-blue-300 hover:text-blue-200">
        ...
        >
          <span className="pill">
            ...
            Premium project starter
          </span>
          <h1 className="mt-6 text-5xl font-black leading-[1.02] tracking-tight text-white">
            Build a lab project that
            <span className="gradient-text"> looks like a real product.</span>
          </h1>
          <p className="mt-5 max-w-xl text-base leading-8 text-slate-400">
            The app includes upload, AI analysis, generated code, live preview, history, and export modules — all wrapped in a polished 2026 interface.
          </p>

          <div className="mt-8 grid max-w-xl gap-3">
            {[
              { icon: Wand2, title: "Sketch to code", desc: "Convert rough wireframes into frontend output." },
              { icon: Cloud, title: "Cloud + local fallback", desc: "Cloudinary and Firestore when configured, local storage when not." },
              { icon: FileArchive, title: "ZIP export", desc: "Submit or run generated files immediately." },
            ].map((item) => {
