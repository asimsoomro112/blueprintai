...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-[calc(100vh-60px)] flex items-center justify-center px-4 py-12 relative">
      <div className="blob bg-blue-500 w-[400px] h-[400px] top-[10%] left-[5%] blob-animate-1" />
      <div className="blob bg-indigo-500 w-[350px] h-[350px] bottom-[10%] right-[10%] blob-animate-2" />
      ...
      >
        <div className="glass-card p-8 sm:p-10 glow-blue">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-sm text-gray-400 mt-1">Sign in to continue to BlueprintAI</p>
          </div>
